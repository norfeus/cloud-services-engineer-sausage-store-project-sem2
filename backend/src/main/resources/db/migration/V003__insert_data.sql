-- Заполнение таблицы `product` тестовыми данными
INSERT INTO
...
-- Генерируем 1 миллион случайных заказов с уникальным идентификатором, случайным статусом и датой создания за последние 90 дней.
...
-- Заполнение таблицы `order_product` тестовыми данными
-- Генерируем 1 миллион записей о продуктах в заказах с указанием количества, идентификатора заказа и идентификатора продукта.
